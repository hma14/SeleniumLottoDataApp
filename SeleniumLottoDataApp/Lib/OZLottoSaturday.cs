...
{
    public class OZLottoSaturday : LottoBase
    {
        public OZLottoSaturday()
        {
            Driver.Url = "https://www.ozlotteries.com/saturday-lotto/results";           
        }
        ...
        internal override void InsertDb()
        {
            ...
            {
                var list = db.OZLottoSats.ToList();
