...
namespace SeleniumLottoDataApp.Lib
{
    public class LottoDailyGrand : LottoBase
    {
        ...
        private List<string> searchDrawNumbers()
        {
            ...
            var td = Driver.FindElements(By.Name("product-winning-numbers__numbers-list")).First();
            ...
            var grand = Driver.FindElements(By.Name("product-winning-numbers__bonus-number_dgrd")).First();
